...
export const PaymentPlanPDFController = async (req:Request, res:Response) => {
    ...
    try{
        ...
        const paymentPlanObject = paymentPlan.toObject() as IPaymentPlanForFractionalOwnership;
...
async function generatePaymentPlanPDF(outputFilePath:string, paymentPlan:IPaymentPlanForFractionalOwnership): Promise<void> {
