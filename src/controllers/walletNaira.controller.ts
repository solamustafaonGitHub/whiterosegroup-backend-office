...
// export const NairaWalletPDFController = async (req:Request, res:Response) => {
//     console.log("Received Request Params:", req.params);
//     const activeSubscriberID = req.params.id; // Extract the activeUserID from the request params
//     console.log("ActiveUserID Wallet Owner:", activeSubscriberID);
//     try {
//         //Use findOne with the activeUserID field explicitly
...
//         }
//         //Use findOne with the nairaWalletID field explicitly
...
//         }
//         //Convert the walletNaira object to a JSON object
//         const nairaWalletObject = walletNaira.toObject() as INairaWalletBalance;
...
async function generateNairaWalletPDF(outputFilePath:string, nairaWallet:INairaWalletBalance): Promise<void> {
    ...
    const filePath = path.join(__dirname, fileName);
        ...
        //------------------Draw a Rectangle A around naira Wallet Information---------------------------------------
