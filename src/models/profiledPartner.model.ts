...
interface IProfiledPartner {
    ...
    profiledPartnerSubType: {type:String, enum:['FEDERAL GOVERNMENT AGENCY/PARASTATAL','STATE GOVERNMENT AGENCY/PARASTATAL','LOCAL GOVERNMENT AGENCY/PARASTATAL','SELF-EMPLOYED'],
        required: true},
