...
;
;
const StandardSaleOrderSchema = new Schema({
...
StandardSaleOrderSchema.pre('save', function (next) {
...
StandardSaleOrderSchema.pre('save', async function (next) {
    try {
...
StandardSaleOrderSchema.pre('validate', function (next) {
    try {
        const items = this.StandardSaleInvoiceItems || [];
...
const StandardSaleOrder = mongoose.model('StandardSaleOrder', StandardSaleOrderSchema);
export { StandardSaleOrder };
